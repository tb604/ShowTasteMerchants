...
@interface MyFinanceMonthEarningCell ()
{
...
@implementation MyFinanceMonthEarningCell
...
- (void)initWithSubViewCell
{
    ...
    [CALayer drawLine:self.contentView frame:CGRectMake(0, kMyFinanceMonthEarningCellHeight, [[UIScreen mainScreen] screenWidth], 0.6) lineColor:[UIColor colorWithHexString:@"#cacaca"]];
...
- (void)initWithContentView
{
    ...
    {
//        NSString *str = @"12月";
//        float fwidth = [str widthForFont:FONTSIZE_12];
        ...
        CGRect frame = CGRectMake(0, 0, [[UIScreen mainScreen] screenWidth], kMyFinanceMonthEarningCellHeight);
...
- (void)initWithMonthGraphView
{
    if (!_monthGraphView)
    {
        ...
        CGRect frame = CGRectMake(0, 10, _contentView.contentSize.width, kMyFinanceMonthEarningCellHeight - 10 - 30);
