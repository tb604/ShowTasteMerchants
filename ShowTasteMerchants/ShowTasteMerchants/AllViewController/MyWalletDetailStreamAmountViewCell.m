//
//  MyWalletDetailStreamAmountViewCell.m
//  ChefDating
//
...
@interface MyWalletDetailStreamAmountViewCell ()
{
    CGFloat _titleWidth;
...
@implementation MyWalletDetailStreamAmountViewCell
...
- (void)initWithSubViewCell
{
    ...
    [CALayer drawLine:self.contentView frame:CGRectMake(0, kMyWalletDetailStreamAmountViewCellHeight, [[UIScreen mainScreen] screenWidth], 0.8) lineColor:[UIColor colorWithHexString:@"#e0e0e0"]];
...
- (void)initWithTitleLabel
{
    if (!_titleLabel)
    {
        CGRect frame = CGRectMake(15, (kMyWalletDetailStreamAmountViewCellHeight-20)/2, _titleWidth, 20);
