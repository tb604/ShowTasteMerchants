...
/**
 Convert object to json string. return nil if an error occurs.（将对象转换为json字符串。如果出现错误返回nil。）
 ...
 */
@interface NSMutableArray (TYZAdd)
...
/**
 Reverse the index of object in this array.(倒序，反向的意思)
