...
/**
 ...
 NSString *strXml = @"<?xml version=\"1.0\" encoding=\"UTF-8\"?> \
 <recipe> \
 ...
 NSDictionary *dict = [NSDictionary dictionaryWithXML:strXml];
...
- (nullable NSNumber *)numverValueForKey:(NSString *)key default:(NSNumber *)def;
- (nullable NSString *)stringValueForKey:(NSString *)key default:(NSString *)def;
...
@interface NSMutableDictionary (TYZAdd)
/**
 Creates and returns a dictionary from a specified property list data.
