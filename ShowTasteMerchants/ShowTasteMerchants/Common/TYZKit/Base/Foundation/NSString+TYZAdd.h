...
/**
 ...
 Returns nil if an error occurs.(字符串的json变成对象的)
...
/**
 Create a string from the file in main bundle (similar to [UIImage imageNamed:]).(从mainBundle里面读取文件的字符串数据)
