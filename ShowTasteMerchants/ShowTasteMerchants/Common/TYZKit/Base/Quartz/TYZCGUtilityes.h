...
CGContextRef _Nullable TYZCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable TYZCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat TYZScreenScale();

/// Get main screen's size. Height is always larger than width.
CGSize TYZScreenSize();
 ...
 */
CGAffineTransform TYZCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform TYZCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode TYZCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *TYZUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect TYZCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale TYZScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize TYZScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth TYZScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight TYZScreenSize().height
#endif
