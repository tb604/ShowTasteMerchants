...
TYZSYNTH_DUMMY_CLASS(UIColor_TYZAdd)

#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void TYZ_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void TYZ_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void TYZ_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void TYZ_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b)
{
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
...
void TYZ_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void TYZ_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b)
{
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
...
void TYZ_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void TYZ_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
{
    CGFloat r, g, b;
    TYZ_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
{
    CGFloat r, g, b;
    TYZ_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
+ (instancetype)colorWithHexString:(NSString *)hexStr alpha:(float)alpha
{
    CGFloat r, g, b, a;
    if (hexStrToRGBA(hexStr, &r, &g, &b, &a))
    {
         ...
         alpha:(CGFloat *)alpha
{
    ...
    TYZ_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
          ...
          alpha:(CGFloat *)alpha
{
    ...
    TYZ_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
