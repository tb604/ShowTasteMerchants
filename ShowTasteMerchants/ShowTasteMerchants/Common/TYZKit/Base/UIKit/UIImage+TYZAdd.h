...
// http://o6ups7pdl.bkt.clouddn.com/broad-1-5.jpg
...
/**
 Whether the data is animated GIF.(判断图片是不是gif动画)
...
/**
 Whether the file in the specified path is GIF.(判断图片是不是gif动画)
...
/**
 ...
 @param clips       A Boolean value that determines whether content are confined to the rect.(剪辑)
 */
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips;

/**
 Returns a new image which is scaled from this image.(图像通过调整大小)
...
/**
 Rounds a new image with a given corner size.(图像中圆形圆角半径)
 ...
 *  @return 
 */
+ (nullable UIImage *)imageWithContentsOfFileName:(NSString *)imageName;
