 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `TYZModel` protocol for custom methods.
 
 
 Sample Code:
 
 ********************** json convertor *********************
 @interface TYZAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation TYZAuthor
 @end
 
 @interface TYZBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) TYZAuthor *author;
 @end
 ...
 NSString *json = @"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}";
 TYZBook *book = [TYZBook modelWithJSON:json];
 debugLog(@"name=%@; pages=%d", book.name, (int)book.pages);
 debugLog(@"author.name=%@", book.author.name);
 
 // convert model to json
 NSString *strJson = [book modelToJSONString];
 debugLog(@"strJsong=%@", strJson);
 }
...
/**
 *  Provides some data-model meothod for NSArray
 */
@interface NSArray (TYZModel)
/**
...
/**
 *  Provide some data-model mthod for NSDictionary
 */
@interface NSDictionary (TYZModel)
/**
