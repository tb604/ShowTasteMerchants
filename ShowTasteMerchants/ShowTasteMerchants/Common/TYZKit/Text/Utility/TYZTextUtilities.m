...
CGAffineTransform TYZTextCGAffineTransformGetFromViews(UIView *from, UIView *to)
{
    ...
    after[0] = [from tyz_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from tyz_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from tyz_convertPoint:before[2] toViewOrWindow:to];
    
    return TYZTextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *TYZTextSharedApplication()
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return TYZTextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
