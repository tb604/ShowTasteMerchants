...
/**
 ...
 @discussion It's also compatible with the custom methods in `NSArray(TYZAdd)`
 and `NSMutableArray(TYZAdd)`
 ...
 */
@interface TYZThreadSafeArray : NSMutableArray
