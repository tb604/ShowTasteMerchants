...
@implementation TYZThreadSafeArray
{
...
{
    LOCK(NSString *desc = _arr.description);
    return desc;
}

- (NSString *)descriptionWithLocale:(id)locale
{
    LOCK(NSString *desc = [_arr descriptionWithLocale:locale]);
    return desc;
}

- (NSString *)descriptionWithLocale:(id)locale indent:(NSUInteger)level
{
    LOCK(NSString *desc = [_arr descriptionWithLocale:locale indent:level]);
    return desc;
}

- (id)firstObjectCommonWithArray:(NSArray *)otherArray
{
    LOCK(id obj = [_arr firstObjectCommonWithArray:otherArray]);
    return obj;
}
...
- (BOOL)isEqualToArray:(NSArray *)otherArray
{
    ...
    if ([otherArray isKindOfClass:TYZThreadSafeArray.class])
    {
        TYZThreadSafeArray *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object
{
    ...
    if ([object isKindOfClass:TYZThreadSafeArray.class])
    {
        TYZThreadSafeArray *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
...
#pragma mark - custom methods for NSArray(TYZAdd)
