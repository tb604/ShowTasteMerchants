...
- (void)newCodeChooose
{
    ...
    [TYZAlertAction showActionSheetWithTitle:@"" message:nil chooseBlock:^(NSInteger buttonIdx) {
...
- (void)createQR1
{
    ...
    _qrImgView.image = [TYZScanWrapper createQRWithString:@"lbxia20091227@foxmail.com" size:_qrImgView.bounds.size];
    
    CGSize logoSize=CGSizeMake(30, 30);
    UIImageView* imageView = [self roundCornerWithImage:[UIImage imageNamed:@"pay_icon_zhifubao"] size:logoSize];
    //UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
    //imageView.backgroundColor = [UIColor redColor];
    //imageView.image = [UIImage imageNamed:@"icon_57"];
    [TYZScanWrapper addImageViewLogo:_qrImgView centerLogoImageView:imageView logoSize:logoSize];
...
- (void)createQR2
{
    ...
    UIImage *image = [TYZScanWrapper createQRWithString:@"lbxia20091227@foxmail.com" size:_qrImgView.bounds.size];
    //二维码上色
    _qrImgView.image = [TYZScanWrapper imageBlackToTransparent:image withRed:255.0f andGreen:74.0f andBlue:89.0f];
...
- (void)createQR3
{
    ...
    _qrImgView.image = [TYZScanWrapper createQRWithString:@"lbxia20091227@foxmail.com"
...
- (void)createCodeEAN13
{
    ...
    _tImgView.image = [TYZScanWrapper createCodeWithString:@"6944551723107" size:_qrImgView.bounds.size CodeFomart:AVMetadataObjectTypeEAN13Code];
}
...
- (void)createCode93
{
    ...
    //支付宝付款码-条款码
    _tImgView.image = [TYZScanWrapper createCodeWithString:@"283657461695996598" size:_qrImgView.bounds.size CodeFomart:AVMetadataObjectTypeCode128Code];
}
