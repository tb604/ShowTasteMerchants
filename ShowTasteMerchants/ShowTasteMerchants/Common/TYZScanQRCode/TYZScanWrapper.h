 ...
 */
@interface TYZScanWrapper : NSObject
...
- (instancetype)initWithPreView:(UIView*)preView ArrayObjectType:(NSArray*)arrayBarCodeType cropRect:(CGRect)cropRect
                        success:(void(^)(NSArray<TYZScanResult *> *array))blockScanResult;
...
/**
 ...
 @return LBXScanVendor
 */
//- (instancetype)initZXingWithPreView:(UIView *)preView success:(void(^)(NSArray<TYZScanResult *> *array))blockScanResult;
 ...
 *  @param block 返回识别结果
 */
+ (void)recognizeImage:(UIImage *)image success:(void(^)(NSArray<TYZScanResult *> *array))block;
