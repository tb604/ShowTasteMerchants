...
//    CGFloat barHeight = 0;
    CGFloat barY = 20;//self.view.frame.size.height - barHeight;
...
//    _descLabel.text = @"电风扇电风是否冯绍峰奋斗发生的打发打发扇";
    _descLabel.numberOfLines = 0;
    _descLabel.font = [UIFont systemFontOfSize:16];
    _descLabel.textColor = [UIColor whiteColor];
    [self.view addSubview:_descLabel];
    _descLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_descLabel]-10-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_descLabel)]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:_descLabel attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:1.0f constant:-20.0f]];
}
...
- (void)showPhotoViewAtIndex:(int)index
{
    ...
    _descLabel.text = photo.imageInfoContent;
